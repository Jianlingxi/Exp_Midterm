                            ...
                            new AlertDialog.Builder(MainActivity.this)
                                    ...
                                    .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            ...
                                            else Toast.makeText(context, "Repeated!", Toast.LENGTH_SHORT).show();
                                        }
                ...
                lv_tag.setOnItemLongClickListener(new OnItemLongClickListener() {
                    ...
                    public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {
                        if (position > 4) {
                            ...
                            blank.animate().translationX(length).setDuration(80).start();
                            TextView text = view.findViewById(R.id.text_tag);
                            text.animate().translationX(length).setDuration(80).start();
                            ImageView del = view.findViewById(R.id.delete_tag);
                            del.setVisibility(View.VISIBLE);
                            del.animate().translationX(length).setDuration(80).start();
    ...
    private void chooseFabColor(int fabColor) {
        ...
        switch (fabColor) {
            ...
            case -500078:
                ...
                myToolbar.setBackgroundTintList(ColorStateList.valueOf(getColor(R.color.t)));
                break;
            case -500083:
                fab.setBackgroundTintList(ColorStateList.valueOf(getColor(R.color.y)));
                myToolbar.setBackgroundTintList(ColorStateList.valueOf(getColor(R.color.y)));
                break;
            case -500079:
                fab.setBackgroundTintList(ColorStateList.valueOf(getColor(R.color.u)));
                myToolbar.setBackgroundTintList(ColorStateList.valueOf(getColor(R.color.u)));
                break;
            case -500063:
                fab.setBackgroundTintList(ColorStateList.valueOf(getColor(R.color.i)));
                myToolbar.setBackgroundTintList(ColorStateList.valueOf(getColor(R.color.i)));
                break;
            case -500066:
                fab.setBackgroundTintList(ColorStateList.valueOf(getColor(R.color.o)));
                myToolbar.setBackgroundTintList(ColorStateList.valueOf(getColor(R.color.o)));
                break;
            case -500069:
                fab.setBackgroundTintList(ColorStateList.valueOf(getColor(R.color.p)));
                myToolbar.setBackgroundTintList(ColorStateList.valueOf(getColor(R.color.p)));
                break;
            default:
                fab.setBackgroundTintList(ColorStateList.valueOf(getColor(R.color.fabColor1)));
                myToolbar.setBackgroundTintList(ColorStateList.valueOf(getColor(R.color.fabColor1)));
        }
    }
